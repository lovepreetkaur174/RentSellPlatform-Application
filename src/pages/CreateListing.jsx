    ...
    <main className='max-w-md px-2 mx-auto'>
        ...
        <form >
            ...
            <div className=''>
              ...
              onChange={onChange} min="1" max="50" required
               className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300
                rounded transition duration-150 ease focus:text-gray-700 focus:bg-white focus:border-slate-600
                 text-center'/>
            </div>
            <div className=''>
          ...
          <textarea type="text" id='address' value='Address' onChange={onChange}
           placeholder='Address' maxLength="32" minLength='10'
          required className='w-full px-4 py-2 text-xl text-gray-700
          bg-white border border-gray-300 rounded transition duration-150 ease-in-out
           focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6' />
           <p className='text-lg mt-6 font-semibold'>Description</p>
          <textarea type="text" id='description' value='Description' onChange={onChange}
           placeholder='Description' maxLength="32" minLength='10'
          required className='w-full px-4 py-2 text-xl text-gray-700
          bg-white border border-gray-300 rounded transition duration-150 ease-in-out
           focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6' />
          ...
          <div className='mb-6'>
            ...
            multiple
            required className='w-full px-3 py-1.5 text-gray-700 bg-white
          ...
          px-7 py-3 bg-blue-600 text-white font-medium text-sm
           uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg
           active: bg-blue-800 transition duration-150 ease-in-out'>Create Listing</button>
        </form>
    </main>
  )
}
